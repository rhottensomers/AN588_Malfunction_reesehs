---
title: "cmetcalf_PeerCommentary_reesehs_04"
author: "Cat Metcalf"
date: "2023-10-29"
...
z.prop.test <- function( p1, n1, p2 = NULL, n2 = NULL, p0, alternative = c("two.sided", "less", "greater"), conf.levels = 0.95) {
  ...
  if(is.null(p2) == TRUE || is.null(n2) == TRUE){
    ...
    ci <- c(lower, upper) #confidence interval, is this correct? *C: i believe it is, yes!; whether it calculates correct within the function I am less sure about...
    ci
  ...
  #unclear how to code this, any help would be much appreciated :') *C: i am not sure if this was referring to the whole chunk or the list function but if it is for list I can help! You can do return(list(estimate = z, p = p, ci=ci)), although you may have to play around with the variables a bit more since mine were a bit different when assigned! Hope that helps!
  }
```
...
ci <- confint(nl, level = 0.90)  # using the results of lm() finds 90% confidence interval *C: nice job! I am pretty sure this does it
ci
